...
#app.config["host"] = "f74a4523879b41058110b64794247994.us-west1.gcp.cloud.es.io"
app.config["username"] = ""
app.config["password"] = ""
...
def update_document():
    ...
    if request.files:
        ...
        # converted_doc = converter.convert(file_path=DOC_path, meta=None)
...
if __name__ == '__main__':
    app.run(threaded=True, host='0.0.0.0', port=8777)
